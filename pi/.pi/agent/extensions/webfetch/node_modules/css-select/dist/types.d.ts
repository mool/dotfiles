...
export interface Adapter<Node, ElementNode extends Node> {
     ...
     */
    getAttributeValue: (element: ElementNode, name: string) => string | undefined;
    /**
...
export interface Options<Node, ElementNode extends Node> {
     ...
     */
    pseudos?: Record<string, string | ((element: ElementNode, value?: string | null) => boolean)> | undefined;
    /**
